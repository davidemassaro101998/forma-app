...
export default function App() {
  ...
  useEffect(() => {
    ...
    const metaDesc = language === "it"
      ? "Trova il prodotto fitness e wellness giusto per il tuo obiettivo su Amazon con l'intelligenza artificiale. Veloce, preciso e senza stress."
      : "Find the right fitness and wellness product for your goal on Amazon with AI. Fast, accurate, and stress-free.";
    ...
    const title = language === "it"
      ? "Forma AI • Il Prodotto Fitness Giusto in 3 Tap"
      : "Forma AI • The Right Fitness Product in 3 Taps";
    ...
    if (typeof window !== "undefined") {
      ...
      if (action === "find_gift") {
        ...
        setQuizState((prev) => ({
          ...
          recipient,
          vibe,
          extraDetails: name ? `Obiettivo: ${name}` : prev.extraDetails,
        }));
        setShowSplash(false);
      }
    }
  ...
  const handleSendFeedback = useCallback(() => {
    if (typeof window !== "undefined") {
      window.open("mailto:support@forma.ai?subject=Feedback%20Forma%20AI", "_blank");
    }
  }, []);
