...
export const TRANSLATIONS: Record<Language, Translations> = {
  it: {
    ...
    resultsHeaderTag: "FORMA AI • 3 SELEZIONI",
    backAria: "Indietro",
    optionLabel: "Opzione",
  ...
  en: {
    ...
    resultsHeaderTag: "FORMA AI • 3 PICKS",
    backAria: "Back",
    optionLabel: "Option",
  ...
  es: {
    ...
    resultsHeaderTag: "FORMA AI • 3 SELECCIONES",
    backAria: "Atrás",
    optionLabel: "Opción",
  ...
  fr: {
    ...
    resultsHeaderTag: "FORMA AI • 3 SÉLECTIONS",
    backAria: "Retour",
    optionLabel: "Option",
  ...
  de: {
    ...
    resultsHeaderTag: "FORMA AI • 3 AUSWAHLEN",
    backAria: "Zurück",
    optionLabel: "Option",
