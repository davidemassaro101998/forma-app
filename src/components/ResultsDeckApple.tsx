  ...
  return (
    <div className="relative w-full h-full bg-tactile-linen flex flex-col justify-between pt-[max(6px,env(safe-area-inset-top,0px))] pb-[max(8px,env(safe-area-inset-bottom,0px))] px-[max(12px,env(safe-area-inset-left,0px))] pr-[max(12px,env(safe-area-inset-right,0px))] select-none max-w-lg sm:max-w-xl md:max-w-2xl mx-auto overflow-hidden font-sans">
      ...
      <div className="flex items-center justify-between shrink-0 pt-0.5 pb-2 border-b border-[#EBE6DC]">
        ...
        <button
          onClick={onStartOver}
          className="py-1 px-2.5 sm:py-1.5 sm:px-3 rounded-full bg-white border border-[#EBE6DC] text-[#0EA968] hover:bg-[#EBE6DC] active:scale-95 transition-transform text-[11px] sm:text-xs font-bold shadow-2xs cursor-pointer shrink-0 ml-1"
        >
            ...
            <AnimatePresence mode="wait" initial={false}>
              ...
              >
                ...
                <div className="flex items-center justify-between shrink-0">
                  ...
                  >
                    <Zap
                      ...
                      style={{
                        color: isPrimary ? "var(--brand-coral)" : "#0EA968",
                ...
                <div className="relative w-full h-[125px] sm:h-[145px] rounded-[16px] sm:rounded-[20px] overflow-hidden bg-[#FAFAFC] border border-[#E5E5EA] flex items-center justify-center p-2 shrink-0">
                  ...
                  <div className="absolute bottom-2 right-2 bg-white text-[#000000] text-xs sm:text-sm font-extrabold px-2.5 py-1 rounded-full shadow-2xs border border-[#E5E5EA]">
                    {currentGift.price}
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-2 w-full shrink-0 pt-0.5">
                  <a
                    ...
                    className="py-2.5 sm:py-3 px-2 rounded-[16px] bg-white border-2 border-[#0EA968] hover:bg-[#F5F1EA] active:scale-[0.98] text-[#0EA968] font-black text-[11px] sm:text-xs flex items-center justify-center gap-1.5 cursor-pointer shadow-2xs transition-transform uppercase tracking-wider"
                  >
