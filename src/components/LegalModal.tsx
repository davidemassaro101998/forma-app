...
export const LegalModal: React.FC<LegalModalProps> = React.memo(({
  ...
  const getIcon = () => {
    if (type === "privacy") return <ShieldCheck className="w-5 h-5 text-[#007AFF]" />;
    if (type === "terms") return <FileText className="w-5 h-5 text-[#007AFF]" />;
    return <ShoppingBag className="w-5 h-5 text-[#007AFF]" />;
  };
          ...
          <div className="flex-1 overflow-y-auto space-y-3.5 text-xs leading-relaxed font-normal text-[#000000] pr-1">
            {type === "privacy" && (
              <>
                ...
                <p>
                  <strong>1. Titolare del Trattamento:</strong> Forma AI opera nel rispetto dei principi di minimizzazione dei dati e riservatezza.
                </p>
                <p>
                  <strong>2. Tipologia di Dati Raccolti:</strong> Forma AI NON raccoglie, profila né vende dati personali degli utenti. L'applicazione funziona interamente tramite salvataggi locali tecnici nel browser/dispositivo dell'utente (localStorage) per memorizzare le impostazioni di lingua, paese Amazon e promemoria calendario.
                </p>
                <p>
            ...
            {type === "terms" && (
              <>
                ...
                <p>
                  <strong>1. Natura del Servizio:</strong> Forma AI è un motore di raccomandazione intelligente sviluppato per suggerire prodotti fitness e wellness reperibili su store online come Amazon.
                </p>
                <p>
                  <strong>2. Esclusione di Responsabilità:</strong> I suggerimenti generati dall'Intelligenza Artificiale hanno scopo informativo ed euristico. Forma AI non è il venditore diretto dei prodotti consigliati.
                </p>
                <p>
                ...
                <p>
                  <strong>4. Proprietà Intellettuale:</strong> Il design, il codice e l'interfaccia di Forma AI sono protetti da copyright. I marchi Amazon e i loghi dei prodotti appartengono ai rispettivi proprietari.
                </p>
              </>
            )}
