        ...
        <>
          ...
          >
            ...
            <div className="w-full space-y-2">
              ...
              <div className="relative w-full">
                <textarea
                  ...
                  className="w-full p-3.5 rounded-[18px] bg-[#F2F2F7] text-[#000000] placeholder-[#68686D] text-base sm:text-lg font-bold leading-snug border border-[#E5E5EA] focus:outline-none focus:border-[#0EA968] transition-colors resize-none"
                />
                {transcript && (
                  <button
                    type="button"
            ...
            <button
              ...
              className="w-full py-4 px-6 rounded-[20px] bg-[#0EA968] hover:bg-[#0B8452] text-white font-black text-sm uppercase tracking-wider flex items-center justify-center gap-2.5 shadow-[0_8px_20px_rgba(14,169,104,0.3)] raised-surface active:scale-[0.98] transition-all cursor-pointer disabled:opacity-40 disabled:cursor-not-allowed border border-[#0EA968] shrink-0 mt-1"
            >
