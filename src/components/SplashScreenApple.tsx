...
export const SplashScreenApple: React.FC<SplashScreenAppleProps> = ({ onComplete }) => {
  ...
  useEffect(() => {
    ...
    // Show mini spinner ~0.2s after the Forma logo has fully taken over
    // (DGM exit ~250ms + Forma's own 800ms entrance ≈ 1600ms).
  ...
  return (
    ...
    >
      ...
      {/* mode="wait": guarantees the DGM mark's exit animation fully
          finishes before the Forma logo starts mounting/entering — never
        ...
        {showDgmMark ? (
          ...
          >
            ...
            <div className="space-y-1">
              ...
              >
                Forma <span style={{ color: "var(--brand-coral)" }}>AI</span>
              </h1>
