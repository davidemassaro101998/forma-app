    ...
    >
      ...
      <div className="shrink-0 pt-0.5">
        ...
        >
          <div className="flex items-center gap-2.5 flex-1 min-w-0">
            <Search className="w-4 h-4 text-[#68686D] group-hover:text-[#0EA968] transition-colors shrink-0" />
            <span className="text-xs sm:text-sm font-medium text-[#68686D] truncate">
        ...
        {wizardStep > 1 && (
          <div className="flex items-center justify-between py-1.5 px-0.5 border-b border-[#E5E5EA]/80 mt-1">
            ...
            <span className="text-xs font-semibold text-[#68686D] truncate max-w-[200px]">
            ...
            >
              ...
              <div className="flex flex-col items-center gap-1.5 pb-1 pt-2">
                ...
                >
                  ...
                  />
                  <span
                    className="absolute inset-0 rounded-full shadow-[0_10px_28px_rgba(14,169,104,0.35)] raised-surface"
                    style={{ backgroundColor: "var(--brand-coral)" }}
                  />
              ...
              <div className="text-center space-y-1">
                ...
                <p className="text-xs text-[#68686D] font-normal">
                  {t.step1Subtitle}
                </p>
              </div>
            ...
            >
              ...
              >
                <div className="flex items-center justify-between">
                  <span className="text-xs font-medium text-[#68686D] block">
                    {t.orExactAmount}
                  </span>
                  {customBudgetInput && (
                ...
                <div className="relative flex items-center">
                  <span
                    className={`absolute left-3.5 text-sm font-bold transition-colors ${
                      isCustomBudgetFocused || customBudgetInput ? "text-[#0EA968]" : "text-[#68686D]"
                    }`}
                  >
                    €
                  </span>
                  ...
                  {customBudgetInput && (
                    <button
                      ...
                      className="absolute right-2.5 p-1 rounded-full bg-[#E5E5EA] text-[#68686D] hover:text-[#000000] transition-colors cursor-pointer"
                      title="Cancella"
                    >
              ...
              <div className="p-[clamp(6px,1.6vh,14px)] rounded-[22px] bg-white border border-[#E5E5EA] shadow-[0_8px_24px_rgba(0,0,0,0.04)] space-y-[clamp(2px,0.8vh,8px)]">
                ...
                <input
                  ...
                  className="w-full py-2 px-3 rounded-xl bg-[#F2F2F7] border border-[#E5E5EA] text-[#000000] placeholder-[#68686D] text-xs sm:text-sm font-normal focus:outline-none focus:border-[#0EA968]"
                />
              </div>
            </motion.div>
          )}
      ...
      {wizardStep === 3 && (
        <div className="shrink-0 pb-[clamp(6px,1.4vh,12px)] pt-[clamp(4px,1vh,8px)] w-full space-y-[clamp(4px,1vh,10px)]">
          {/* Selection recap — same "X • Y (Z)" phrasing as the results
              header, so step 3 reads as a preview of what you're about to
              get rather than dead space before the button. */}
          <div className="flex items-center justify-center gap-1.5 text-xs font-semibold text-[#68686D]">
            ...
            <span className="truncate">
              {recipient} • {vibe} ({budget})
            </span>
          </div>
          <button
            onClick={handleFinalSubmit}
            className="w-full py-4 rounded-[22px] bg-[#0EA968] hover:bg-[#0B8452] active:scale-[0.97] text-white font-bold text-sm sm:text-base flex items-center justify-center gap-2 cursor-pointer shadow-[0_8px_24px_rgba(14,169,104,0.3)] raised-surface transition-all uppercase tracking-wide border border-[#0EA968]"
          >
