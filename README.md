...
Trova il prodotto fitness e wellness giusto per il tuo obiettivo in 3 tap:
l'utente descrive l'obiettivo (o lo dice a voce), Gemini propone 3 prodotti
reali con link d'acquisto su Amazon. Parte della famiglia
[DGM Apps](https://github.com/davidemassaro101998/dgm-apps-site), insieme a
[Kado AI](https://github.com/davidemassaro101998/kado-app) e
[Bricolo AI](https://github.com/davidemassaro101998/bricolo-app).
...
registrati per questa app prima del lancio (attualmente condivide gli stessi
tag di Kado AI, da separare).
